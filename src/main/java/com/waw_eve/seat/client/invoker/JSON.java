...
import com.waw_eve.seat.client.model.Squad;
...
public class JSON {
	...
	public static GsonBuilder createGson() {
		GsonFireBuilder fireBuilder = new GsonFireBuilder()
				.registerTypeSelector(SquadResource.class, new TypeSelector<SquadResource>() {
					@Override
					public Class<? extends SquadResource> getClassForElement(JsonElement readElement) {
						Map<String, Class<? extends SquadResource>> classByDiscriminatorValue = new HashMap<>();
						classByDiscriminatorValue.put("Squad".toUpperCase(), Squad.class);
						classByDiscriminatorValue.put("SquadResource".toUpperCase(), SquadResource.class);
						return getClassByDiscriminator(classByDiscriminatorValue,
								getDiscriminatorValue(readElement, ""));
					}
				}).registerPostProcessor(SquadResource.class, new PostProcessor<SquadResource>() {
					@Override
					public void postDeserialize(SquadResource result, JsonElement src, Gson gson) {

					}

					@Override
					public void postSerialize(JsonElement result, SquadResource src, Gson gson) {
						Map<Class<? extends SquadResource>, String> discriminatorValueByClass = new HashMap<>();
						discriminatorValueByClass.put(Squad.class, "Squad");
						discriminatorValueByClass.put(SquadResource.class, "SquadResource");
