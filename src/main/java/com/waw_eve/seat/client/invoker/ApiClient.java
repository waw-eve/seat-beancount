...
import com.waw_eve.seat.client.invoker.auth.ApiKeyAuth;
import com.waw_eve.seat.client.invoker.auth.Authentication;
import com.waw_eve.seat.client.invoker.auth.HttpBasicAuth;
import com.waw_eve.seat.client.invoker.auth.OAuth;
...
public class ApiClient {
	...
	private String basePath = "https://seat.waw-eve.com/api";
	...
	public ApiClient() {
		...
		authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "X-Token"));
	 ...
	 * Set base path
	 *
	 * @param basePath Base path of the URL (e.g https://seat.waw-eve.com/api
